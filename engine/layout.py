...
# 敵人圖顯示區域（左面板內水平置中）的中心點，出牌飛出動畫的終點。
ENEMY_ART_CENTER_X = LEFT_CONTENT_START + (LEFT_CONTENT_END - LEFT_CONTENT_START + 1) // 2
ENEMY_ART_CENTER_Y = ENEMY_ART_TOP + ENEMY_ART_HEIGHT // 2
